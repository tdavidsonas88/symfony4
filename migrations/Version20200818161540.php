 ...
 */
final class Version20200818161540 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE video ADD format VARCHAR(255) NOT NULL, ADD duration INT NOT NULL, CHANGE id id INT NOT NULL');
